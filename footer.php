<footer class="page-footer" style="margin-top: 120px; box-shadow: 0px 0px 2px white; background-color: rgb(17,17,17)">
  <div class="row wide-container">
    <div class="col s3">
      <h4 class="white-text bold ">Vintagee</h4>
      <p class="grey-text text-lighten-4">Your favorite online Clothing Store.</p>
    </div>
    <div class="col s2">
  ...
  <div class="footer-copyright" style="padding-bottom: 20px;">
    <div class="wide-container">©2023 Vintagee all rights reserved.</div>
  </div>
