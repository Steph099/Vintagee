...
<body>
  <head>
    ...
    <title>Vintagee - Product Catalogue</title>
    <?php 
            ...
            <div class="section" style="margin-bottom: 100px;">
              <div class="col unglow">
                <ul id="filter_dropdown" class="dropdown-content black">
                  ...
                  <li><a class="cyan-text page-title" onclick="select_category(this)">Tops</a></li>
                  <li><a class="cyan-text page-title" onclick="select_category(this)">Bottoms</a></li>
            ...
            <div class="section">
              <div class="col unglow">
                <ul id="choose_dropdown" class="dropdown-content black">
                  ...
                  <li><a class="cyan-text page-title" onclick="select_brand(this)">Hugo</a></li>
                  <li><a class="cyan-text page-title" onclick="select_brand(this)">Champion</a></li>
                  <li><a class="cyan-text page-title" onclick="select_brand(this)">Levi</a></li>
                  <li><a class="cyan-text page-title" onclick="select_brand(this)">Buffalo</a></li>
                  <li><a class="cyan-text page-title" onclick="select_brand(this)">Guess</a></li>
                  <li><a class="cyan-text page-title" onclick="select_brand(this)">Crocs</a></li>
                  <li><a class="cyan-text page-title" onclick="select_brand(this)">Columbia</a></li>
                </ul>
